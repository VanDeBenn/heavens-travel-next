...
export default function BannerHotelList({ data, location }: ComponentProps) {
  ...
  const filteredHotels = data?.filter((hotel: any) => {
    ...
    const provinceName = hotel?.city?.province?.name || "";
