...
// import { Empty, Input, Select, Button, Pagination, DatePicker } from "antd";
// import "antd/dist/reset.css"; // Untuk reset default styling Ant Design
...
//         <Empty description="No data available" className="mb-6" />
//       </div>

//       {/* Input */}
//       <div className="w-full">
//         <Input placeholder="Enter text" className="w-full mb-6" />
//       </div>

//       {/* Select */}
//       <div className="w-full">
//         <Select defaultValue="option1" className="w-full mb-6">
...
//       {/* Button */}
//       <div className="w-full">
//         <Button type="primary" className="w-full mb-6">
//           Submit
//         </Button>
//       </div>
...
//       {/* Pagination */}
//       <div className="w-full">
//         <Pagination defaultCurrent={1} total={50} className="mb-6" />
//       </div>

//       {/* DatePicker */}
//       <div className="w-full">
//         <DatePicker className="w-full mb-6" />
//       </div>
//     </div>
//   );
// };
