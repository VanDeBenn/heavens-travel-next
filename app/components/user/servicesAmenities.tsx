...
const servicesAmenitiesData = {
  ...
  internet: [
    { icon: <FaWifi className="text-lg text-[#4F28D9]" />, text: "Internet" },
    { icon: <IoMdWifi className="text-lg text-[#4F28D9]" />, text: "Free Wi-Fi in all rooms" },
    { icon: <MdOutlineCellWifi className="text-lg text-[#4F28D9]" />, text: "Wi-Fi in public areas" },
  ],
  facilities: [
    { icon: <FaHeadset className="text-lg text-[#4F28D9]" />, text: "Receptionist 24h" },
    { icon: <PiOvenFill className="text-lg text-[#4F28D9]" />, text: "Kitchen" },
    { icon: <FaSwimmingPool className="text-lg text-[#4F28D9]" />, text: "Swimming Pool" },
    { icon: <FaShower className="text-lg text-[#4F28D9]" />, text: "Shower" },
    { icon: <FaDumbbell className="text-lg text-[#4F28D9]" />, text: "Gym" },
    { icon: <PiCigaretteSlashDuotone className="text-lg text-[#4F28D9]" />, text: "Smoking Room" },
    { icon: <TbBed className="text-lg text-[#4F28D9]" />, text: "SPA Room" },
  ],
  servicesConveniences: [
    { icon: <TbAirConditioning className="text-lg text-[#4F28D9]" />, text: "Air Conditioning in public area" },
    { icon: <AiOutlineReconciliation className="text-lg text-[#4F28D9]" />, text: "Concierge" },
    { icon: <GiHighGrass className="text-lg text-[#4F28D9]" />, text: "Terrace" },
    { icon: <MdCurrencyExchange className="text-lg text-[#4F28D9]" />, text: "Currency exchange" },
    { icon: <GiBroom className="text-lg text-[#4F28D9]" />, text: "Daily housekeeping" },
    { icon: <LuMonitorDot className="text-lg text-[#4F28D9]" />, text: "Internet service" },
  ],
};
